...
class Song
{
    ...
    /**
     * Gets the full info card of this Song
     * @return string description
     */
    public function getInfo(): string{
        return "§a Now playing: " . (empty($this->getTitle()) ? basename($this->path, ".nbs") : $this->getTitle()) . (empty($this->getAuthor()) ? "" : " by " . $this->getAuthor());
    }
